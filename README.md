...
3. If you want zero-config AI scoring, deploy the Firebase function in `firebase/functions/` and set `AIProxyURL` in [DailyLogs/Resources/Info.plist](DailyLogs/Resources/Info.plist) to the deployed HTTPS URL.
